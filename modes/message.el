...
(defun my/notmuch-close-window-after-send (&rest _)
  (if (one-window-p)
	(save-buffers-kill-terminal)
    (when (window-live-p (selected-window)) (delete-window))))

(advice-add 'message-send-and-exit :after #'my/notmuch-close-window-after-send)
